...
** Setting up Directories and files [2/3]
...
*** TODO Files [0/2] :FILE:
**** TODO Create/Open and Close [10/10]
...
*** TODO File_Seek and Dir/File_UnLink NOTE THAT FILE SEEK AND UNLINK IS IN BEFORE SEcTION[4/10] :FILE:DIR: 
    Error -> osErrMsg
...
*** Tuesday, 3 days left
    ...
    - Almsot done wtih project. now, 1 funciton left.
* Specifications 
